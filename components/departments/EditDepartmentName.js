...
const EditDepartmentName = ({ department, departmentNameEdit }) => {

    //Department context
    const departmentContext = useContext(DepartmentContext);
    const { addDepartmentName } = departmentContext

    const [ departmentName, setDepartmentName ] = useState(departmentNameEdit);
        ...
        <>
            ...
            <div className="mb-4 mt-3">
                <input 
                    ...
                    defaultValue={ departmentNameEdit }
                />
            </div>
